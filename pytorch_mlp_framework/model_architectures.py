...
# test Default
# def testConvolutionalProcessingBlock():
#     block = ConvolutionalProcessingBlock(input_shape=(4, 32, 32, 32), num_filters=32, kernel_size=3, padding=1, bias=True, dilation=1)
#     x = torch.randn(4, 32, 32, 32)
#     output = block(x)
#     print(output.shape)  # 应输出 (4, 32, 32, 32)
# testConvolutionalProcessingBlock()

# def testConvolutionalDimensionalityReductionBlock():
#     block = ConvolutionalDimensionalityReductionBlock(input_shape=(4, 32, 32, 32), num_filters=32, kernel_size=3, padding=1, bias=True, dilation=1, reduction_factor=2)
#     x = torch.randn(4, 32, 32, 32)
#     output = block(x)
#     print(output.shape)  # 应输出 (4, 32, 16, 16)
# testConvolutionalDimensionalityReductionBlock()

# Res
class ConvolutionalProcessingBlock_r(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_r, self).__init__()
...
# test Res
# def testConvolutionalProcessingBlock_r():
#     block = ConvolutionalProcessingBlock_r(input_shape=(4, 32, 32, 32), num_filters=32, kernel_size=3, padding=1, bias=True, dilation=1)
#     x = torch.randn(4, 32, 32, 32)
#     output = block(x)
#     print(output.shape)  # 应输出 (4, 32, 32, 32)
# testConvolutionalProcessingBlock_r()

# BN
class ConvolutionalProcessingBlock_b(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_b, self).__init__()
...
class ConvolutionalDimensionalityReductionBlock_b(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlock_b, self).__init__()
...
# test BN
# def testConvolutionalProcessingBlock_b():
#     block = ConvolutionalProcessingBlock_r(input_shape=(4, 32, 32, 32), num_filters=32, kernel_size=3, padding=1, bias=True, dilation=1)
#     x = torch.randn(4, 32, 32, 32)
#     output = block(x)
#     print(output.shape)  # 应输出 (4, 32, 32, 32)
# testConvolutionalProcessingBlock_b()
# def testConvolutionalDimensionalityReductionBlock_b():
#     block = ConvolutionalDimensionalityReductionBlock_b(input_shape=(4, 32, 32, 32), num_filters=32, kernel_size=3, padding=1, bias=True, dilation=1, reduction_factor=2)
#     x = torch.randn(4, 32, 32, 32)
#     output = block(x)
#     print(output.shape)  # 应输出 (4, 32, 16, 16)
# testConvolutionalDimensionalityReductionBlock_b()

# BN+Res
class ConvolutionalProcessingBlock_br(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_br, self).__init__()
...
#     output = block(x)
#     print(output.shape)  # 应输出 (4, 32, 32, 32)
# testConvolutionalProcessingBlock_br()